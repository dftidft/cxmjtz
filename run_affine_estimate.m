...
%         angle_point_pairs = atan2(dist(:, 2), dist(:, 1));
    ...
    if iframe > 1
        ...
        % Refactor the following code by function affine_estimate
        [center, scale, rotation] = affine_estimate(of_tracked_keypoints, prev_keypoints, ind_tracked_keypoints);
